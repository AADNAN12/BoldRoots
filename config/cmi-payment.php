...
return [
    ...
    * */
     ...
     * */
    'okUrl' => env('CMI_OK_URL', 'http://localhost:8000/cmi/okUrl'),

    /*
     * L'URL utilisée pour rediriger le client vers le site marchand en cas d'autorisation de paiement échouée.
     * */
    'failUrl' => env('CMI_FAIL_URL', 'http://localhost:8000/cmi/failUrl'),
     ...
     * */
    'shopUrl' => env('CMI_SHOP_URL', 'http://localhost:8000/checkout'),

    /*
     * L'URL utilisée dans la requête de confirmation de paiement en mode server-to-server
     * */
    'callbackUrl' => env('CMI_CALLBACK_URL', 'http://localhost:8000/cmi/callback'),
