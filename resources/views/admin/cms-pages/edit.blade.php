...
@section('title', 'Modifier la Page CMS')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0">Modifier la Page CMS</h2>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                                   id="slug" name="slug" value="{{ old('slug', $cmsPage->slug) }}" placeholder="Généré automatiquement si vide">
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                   id="order" name="order" value="{{ old('order', $cmsPage->order) }}" min="0">
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card border-0 shadow-sm mt-3">
                    <div class="card-body">
                        ...
                        <p class="small text-muted mb-2">
                            ...
                            {{ $cmsPage->created_at->format('d/m/Y à H:i') }}
                        </p>
                        <p class="small text-muted mb-0">
                            <strong>Modifié le:</strong><br>
                            {{ $cmsPage->updated_at->format('d/m/Y à H:i') }}
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.getElementById('title').addEventListener('input', function() {
        ...
        if (document.getElementById('slug').value === originalSlug || document.getElementById('slug').dataset.auto) {
